...
| 插件 | 说明 | 版本 |
|------|------|------|
| **req** | 需求全流程管理 — 从需求分析到测试归档的完整生命周期 | v1.9.4 |
...
claude plugins install req@aiforge    # 需求管理
claude plugins install pm@aiforge     # 项目管理助手
claude plugins install api@aiforge    # API 对接工具
```
...
claude plugins update req@aiforge     # 更新插件
claude plugins uninstall req@aiforge  # 卸载插件
```
