...
分两阶段完善需求文档的**需求定义章节**（一~六）：

**阶段一：用户填写（交互引导）**

1. **一、需求描述**（背景、目标、客户场景、价值）
   - 提示用户填写，客户场景可以有多个
2. **四、使用场景**（角色、前置条件、基本流程、异常流程）
   - 提示用户填写，可以有多个场景

**阶段二：AI 自动生成（需求和场景确认后）**

基于用户填写的需求描述和使用场景，AI 自动完成以下章节：
3. **二、功能清单**（从使用场景中提取原子功能点）
4. **三、业务规则**（从使用场景中提炼规则约束）
5. **五、API 设计**（如涉及，仅描述业务语义）
6. **六、测试要点**（关键测试场景和预期结果）
