...
> 模板源文件：`plugins/req/templates/`，写入规范：`_storage.md`（见附录：_storage.md），索引格式：[`index-template.md`](../templates/index-template.md)，架构片段：[`claude-md-snippets/`](../templates/claude-md-snippets/)，release 模板：[`release-prompt-template.md`](../templates/release-prompt-template.md)
